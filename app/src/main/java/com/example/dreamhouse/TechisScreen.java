...
public class TechisScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_techis_screen);
        ...
        FirebaseRecyclerOptions<Vendoritemmodel> options =
                new FirebaseRecyclerOptions.Builder<Vendoritemmodel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("Techis"), Vendoritemmodel.class)
                        .build();
