...
import com.example.dreamhouse.helper.LocaleHelper;
...
//            Toast.makeText(getActivity(), "Language already selected!"+localeName+dm+conf+currentLang, Toast.LENGTH_SHORT).show();
